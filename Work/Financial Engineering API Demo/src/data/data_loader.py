...
class DataLoader:
    ...
    def __init__(
        ...
        self.crypto_client = CryptoClient() if CryptoClient else None
        self.forex_client = ForexClient() if ForexClient else None
        self.metals_client = MetalsClient() if MetalsClient else None
